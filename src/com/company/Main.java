...
public class Main {
	...
	static final String userName="rsussa1";//put your MySQL user name
    static final String password="Cosc*q76p";//put your MySQL password
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        updateStaff = null;
            String querys="select * from rsussa1db.Employee;";
